              ...
              <div className="grid grid-cols-2 gap-3 mt-2">
                <button
                  ...
                  style={{
                    ...
                    boxShadow: type === 'PERCENT' ? '0 0 0 1px rgba(74,144,226,0.15)' : 'none',
                  }}
                >
                  <div
                    className="w-10 h-10 rounded-lg flex items-center justify-center shrink-0"
                    style={{
                      background: type === 'PERCENT' ? 'rgba(74,144,226,0.2)' : 'var(--surface3)',
                ...
                <button
                  ...
                  style={{
                    ...
                    boxShadow: type === 'FIXED' ? '0 0 0 1px rgba(74,144,226,0.15)' : 'none',
                  }}
                >
                  <div
                    className="w-10 h-10 rounded-lg flex items-center justify-center shrink-0"
                    style={{
                      background: type === 'FIXED' ? 'rgba(74,144,226,0.2)' : 'var(--surface3)',

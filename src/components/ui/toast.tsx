...
const toastVariants = cva(
  'pointer-events-auto bg-[#1a1a1a] border-l-4 border-[var(--gold)] p-4 font-sans text-[13px] text-[#f0ede6] data-[state=open]:animate-in data-[state=closed]:animate-out data-[swipe=end]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom',
  {
    variants: {
      variant: {
        default: '',

...
export function RequestApprovalAgainButton({ storeId }: { storeId: string }) {
  ...
  return (
    <button
      ...
      onClick={handleClick}
      disabled={loading}
      className="mt-4 inline-flex items-center gap-2 rounded-xl px-4 py-2.5 font-sans text-[13px] font-semibold bg-[var(--gold)] text-black hover:opacity-90 disabled:opacity-60"
    >

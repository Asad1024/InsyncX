          ...
          <div className="flex items-center gap-2 mb-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="inline-flex rounded-lg border p-0.5" style={{ borderColor: 'var(--line)', background: 'var(--surface2)' }}>
                ...
                <button type="button" onClick={() => setIsFeatured(true)} className="rounded-md px-3 py-1.5 font-sans text-[12px] font-medium transition-colors" style={{ background: isFeatured ? 'var(--gold)' : 'transparent', color: isFeatured ? '#0D0D0F' : 'var(--text-4)' }}>On</button>
              </div>
            </div>
            <div className="flex items-center gap-3">
              ...
              <div className="inline-flex rounded-lg border p-0.5" style={{ borderColor: 'var(--line)', background: 'var(--surface2)' }}>
                ...
                <button type="button" onClick={() => setIsNewArrival(true)} className="rounded-md px-3 py-1.5 font-sans text-[12px] font-medium transition-colors" style={{ background: isNewArrival ? 'var(--gold)' : 'transparent', color: isNewArrival ? '#0D0D0F' : 'var(--text-4)' }}>On</button>
              </div>
            </div>
            <div className="flex items-center gap-3">
              ...
              <div className="inline-flex rounded-lg border p-0.5" style={{ borderColor: 'var(--line)', background: 'var(--surface2)' }}>
                ...
                <button type="button" onClick={() => setIsActive(true)} className="rounded-md px-3 py-1.5 font-sans text-[12px] font-medium transition-colors" style={{ background: isActive ? 'var(--gold)' : 'transparent', color: isActive ? '#0D0D0F' : 'var(--text-4)' }}>On</button>
              </div>
            </div>
          </div>
        </div>

  ...
  return (
    <div>
      <PageHeader
        ...
        actions={
          <Link href="/admin/categories/new" className="btn btn-primary rounded-xl px-5 py-2.5 font-sans text-[14px] font-semibold bg-[var(--gold)] text-black hover:opacity-90">
            Add category
          </Link>
        }
      />

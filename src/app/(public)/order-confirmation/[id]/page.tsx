    ...
    <div className="min-h-screen bg-[var(--bg)]">
      ...
      <div className="max-w-2xl mx-auto py-12 px-4 md:px-6">
        ...
        <div className="flex flex-wrap gap-4 justify-center mb-8">
          ...
          <Link
            href="/shop"
            className="inline-flex items-center gap-2 font-sans text-[13px] font-semibold uppercase tracking-[0.2em] px-8 py-3 rounded-[10px] bg-[var(--gold)] text-black hover:opacity-90 transition-opacity"
          >
            Continue shopping
          </Link>
        </div>

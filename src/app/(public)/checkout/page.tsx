        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="btn btn-primary font-sans text-[13px] font-semibold uppercase tracking-[0.2em] px-8 py-3 rounded-[10px] bg-[var(--gold)] text-white hover:opacity-90 disabled:opacity-50 transition-opacity"
            >

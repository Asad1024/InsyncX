  ...
  return (
    <div>
      <PageHeader
        ...
        actions={
          <Link href="/vendor/products/new" className="btn btn-primary rounded-xl px-5 py-2.5 font-sans text-[14px] font-semibold bg-[var(--gold)] text-white hover:opacity-90">

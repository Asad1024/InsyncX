          ...
          <section className="panel p-6">
            ...
            <div className="flex items-center gap-3">
              {store.isApproved ? (
                ...
                <>
                  <div
                    className="w-10 h-10 rounded-xl flex items-center justify-center shrink-0"
                    style={{ background: 'var(--amber-bg)', border: '1px solid rgba(245,158,11,0.2)' }}
                  >
            ...
            {!store.isApproved && !store.declinedAt && (
              <div
                ...
                style={{ background: 'var(--amber-bg)', border: '1px solid rgba(245,158,11,0.15)', color: 'var(--text-2)' }}
              >
